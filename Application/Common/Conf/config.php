...
return array(
	...
	'MEMCACHED_SERVER'      =>  '121.41.51.22',    // 数据库表前缀
	'DATA_CACHE_TIME'       =>  0,      		// 数据缓存有效期 0表示永久缓存
	'DATA_CACHE_PREFIX'     =>  'zb_xingce_',   // 缓存前缀
	
	/* 队列设置 */
	'HTTPSQS_HOST'			=>  '121.41.51.22',
	'HTTPSQS_PORT'			=>  1218,
	'HTTPSQS_AUTH'			=>  'mypass123',
    ...
    'COOKIE_DOMAIN'         =>  'zoobao.com',      // Cookie有效域名
    'COOKIE_PATH'           =>  '/',     // Cookie路径
    'COOKIE_PREFIX'         =>  'zb_',      // Cookie前缀 避免冲突
	...
	'TMPL_PARSE_STRING'  =>array(
		 ...
		 '__UPLOAD__' 		=> 'http://www.zoobao.com/Uploads/', 		// 上传路径替换规则
